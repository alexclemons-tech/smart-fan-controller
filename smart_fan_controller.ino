 ...
 * - Rotary encoder navigation (UP-only scrolling)
...
#define PIN_ROTARY_CLK      5   // Rotary encoder clock (SWAPPED)
#define PIN_ROTARY_DT       4   // Rotary encoder data (SWAPPED)
#define PIN_ROTARY_SW       6   // Rotary encoder switch
#define PIN_FAN_PWM         1   // PWM output to TL-C14 fan
...
#define FAN_PWM_CHANNEL     1      // LEDC channel 1
...
// ============================================================================
// ROTARY ENCODER HANDLING (UP-ONLY)
// ============================================================================
...
void handle_rotary_encoder() {
  ...
  if (current_clk != rotary_state.last_clk && (now - last_count_time) > MIN_PULSE_INTERVAL) {
    ...
    if (current_clk == LOW) {
      ...
      // (Disabled down direction due to encoder hardware sensitivity)
